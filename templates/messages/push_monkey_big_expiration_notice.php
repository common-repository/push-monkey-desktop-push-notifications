<div class="push-monkey-bootstrap">
	<div class="error clearfix push-monkey-expired-notice" style="background-image:url('<?php echo $image_url; ?>')"> 
		<div class="button-wrapper text-center">
			<a href="<?php echo $upgrade_url; ?>" target="_blank" class="btn btn-danger btn-lg">Upgrade Now</a>
		</div>
		<div class="text-wrapper">
			<h4>Your Trial Plan Expired</h4>
			<p>
				<strong>Sad News: </strong>Because your trial plan is over, push notifications will 
